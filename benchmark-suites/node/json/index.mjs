/**
 * Бенчмарк парсинга и сериализации JSON для Node.js - ESM версия
 */
import path from 'path';
import { fileURLToPath } from 'url';
import { benchmark } from '../utils/metrics.mjs';
import { preventOptimization } from '../utils/deoptimize.mjs';
...
async function runBenchmark() {
  ...
  console.log(`Запуск бенчмарка JSON для Node.js (${process.version})`);
  ...
  const benchmarkOptions = {
    ...
    outputPath: path.join(__dirname, '../../../results', `node_json_${operation}_size${objectSize}_${Date.now()}.json`)
  };
